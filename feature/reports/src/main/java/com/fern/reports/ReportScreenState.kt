...
data class ReportScreenState(
    ...
    val upcomingTransactions: ImmutableList<com.fern.base.legacy.Transaction> = persistentListOf(),
    val overdueTransactions: ImmutableList<com.fern.base.legacy.Transaction> = persistentListOf(),
    ...
    val transactions: ImmutableList<com.fern.base.legacy.Transaction> = persistentListOf(),
