...
sealed class ReportScreenEvent {
    ...
    data class SkipTransactionsLegacy(val transactions: List<com.fern.base.legacy.Transaction>) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class SkipTransactionLegacy(val transaction: com.fern.base.legacy.Transaction) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class OnPayOrGetLegacy(val transaction: com.fern.base.legacy.Transaction) :
        ReportScreenEvent()
}
