package com.fern.importdata.csv
...
import com.fern.importdata.csv.domain.CSVImporterV2
import com.fern.importdata.csv.domain.SAMPLE_SIZE
import com.fern.importdata.csv.domain.parseAccount
import com.fern.importdata.csv.domain.parseAccountCurrency
import com.fern.importdata.csv.domain.parseAmount
import com.fern.importdata.csv.domain.parseCategory
import com.fern.importdata.csv.domain.parseDate
import com.fern.importdata.csv.domain.parseDescription
import com.fern.importdata.csv.domain.parseStatus
import com.fern.importdata.csv.domain.parseTitle
import com.fern.importdata.csv.domain.parseToAccount
import com.fern.importdata.csv.domain.parseToAccountCurrency
import com.fern.importdata.csv.domain.parseTransactionType
        ...
        withContext(Dispatchers.IO) {
            val result = csvImporter.import(
                ...
                onProgress = { progressPercent ->
                    com.fern.legacy.utils.uiThread {
