package com.fern.importdata.csvimport
...
import com.fern.legacy.domain.deprecated.logic.csv.CSVImporter
...
import com.fern.base.legacy.getFileName
import com.fern.navigation.ImportScreen
import com.fern.navigation.Navigation
import com.fern.onboarding.viewmodel.OnboardingViewModel
import com.fern.wallet.domain.deprecated.logic.csv.CSVMapper
import com.fern.wallet.domain.deprecated.logic.csv.CSVNormalizer
import com.fern.data.file.FileSystem
import com.fern.data.backup.ImportResult
...
class ImportViewModel @Inject constructor(
    ...
    private suspend fun restoreCSVFile(fileUri: Uri, importType: ImportType): ImportResult {
        return com.fern.legacy.utils.ioThread {
    ...
    private suspend fun hasCSVExtension(
        context: Context,
        fileUri: Uri
    ): Boolean = com.fern.legacy.utils.ioThread {
