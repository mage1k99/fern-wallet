...
import com.fern.wallet.ui.theme.IvyLight
import com.fern.wallet.ui.theme.Orange
import com.fern.wallet.ui.theme.Red
import com.fern.wallet.ui.theme.RedLight
...
import com.fern.wallet.ui.theme.components.CircleButtonFilledGradient
import com.fern.wallet.ui.theme.components.CloseButton
import com.fern.wallet.ui.theme.components.ItemIconM
...
import com.fern.wallet.ui.theme.gradientExpenses
import com.fern.wallet.ui.theme.modal.ChoosePeriodModal
import com.fern.wallet.ui.theme.pureBlur
...
private fun BoxWithConstraintsScope.UI(
    ...
    val percentExpanded by animateFloatAsState(
        ...
        animationSpec = com.fern.legacy.utils.springBounce(),
...
private fun Header(
    ...
    period: com.fern.legacy.data.model.TimePeriod,
            ...
            if (percentExpanded > 0f) {
                ...
                CircleButtonFilledGradient(
                    modifier = Modifier
                        ...
                        .alpha(percentExpanded)
                        .size(com.fern.legacy.utils.lerp(1, 40, percentExpanded).dp),
                    iconPadding = 4.dp,
...
private fun Preview_Expense() {
    com.fern.legacy.IvyWalletPreview {
        val state = PieChartStatisticState(
            ...
            period = com.fern.legacy.data.model.TimePeriod.currentMonth(
                startDayOfMonth = 1
            ), // preview
            baseCurrency = "BGN",
            totalAmount = 1828.0,
