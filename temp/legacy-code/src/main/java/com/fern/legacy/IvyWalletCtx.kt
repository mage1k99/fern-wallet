...
class IvyWalletCtx @Inject constructor() : IvyContext() {
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var selectedPeriod: com.fern.legacy.data.model.TimePeriod =
        com.fern.legacy.data.model.TimePeriod.currentMonth(
    ...
    ): com.fern.legacy.data.model.TimePeriod {
        if (!selectedPeriodInitialized || forceReinitialize) {
            selectedPeriod = com.fern.legacy.data.model.TimePeriod.currentMonth(
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun updateSelectedPeriodInMemory(period: com.fern.legacy.data.model.TimePeriod) {
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var mainTab by mutableStateOf(com.fern.legacy.data.model.MainTab.HOME)
        private set

    @Deprecated("Legacy code. Don't use it, please.")
    fun selectMainTab(tab: com.fern.legacy.data.model.MainTab) {
        mainTab = tab
    }
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun reset() {
        mainTab = com.fern.legacy.data.model.MainTab.HOME
        startDayOfMonth = 1
        isPremium = true
