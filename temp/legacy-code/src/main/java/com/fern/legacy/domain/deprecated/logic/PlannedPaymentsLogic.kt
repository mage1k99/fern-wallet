...
import com.fern.data.temp.migration.settleNow
...
import com.fern.wallet.domain.deprecated.logic.currency.sumByDoublePlannedInBaseCurrency
...
class PlannedPaymentsLogic @Inject constructor(
    ...
    suspend fun plannedPaymentsAmountFor(range: com.fern.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun payOrGet(
        transaction: com.fern.data.model.Transaction,
        syncTransaction: Boolean = true,
        skipTransaction: Boolean = false,
        onUpdateUI: suspend (paidTransaction: com.fern.data.model.Transaction) -> Unit
    ) {
    ...
    suspend fun payOrGet(
        transactions: List<com.fern.data.model.Transaction>,
        syncTransaction: Boolean = true,
        skipTransaction: Boolean = false,
        onUpdateUI: suspend (paidTransactions: List<com.fern.data.model.Transaction>) -> Unit
    ) {
        val paidTransactions: List<com.fern.data.model.Transaction> =
