...
import com.fern.data.db.dao.read.CategoryDao
...
import com.fern.data.db.dao.read.TagDao
import com.fern.data.db.dao.read.TagAssociationDao
...
import com.fern.data.db.dao.write.WriteCategoryDao
...
import com.fern.data.db.dao.write.WriteTagDao
import com.fern.data.db.dao.write.WriteTagAssociationDao
import com.fern.data.db.dao.write.WriteTransactionDao
...
import com.fern.data.db.entity.UserEntity
import com.fern.data.db.migration.Migration123to124_LoanIncludeDateTime
import com.fern.data.db.migration.Migration124to125_LoanEditDateTime
import com.fern.data.db.migration.Migration126to127_LoanRecordType
import com.fern.data.db.migration.Migration127to128_PaidForDateRecord
import com.fern.data.db.migration.Migration128to129_DeleteIsDeleted
import com.fern.data.db.migration.Migration129to130_LoanIncludeNote
import com.fern.data.db.migration.Migration130to131_ArchiveCategories
import com.fern.data.db.migration.Migration131to132_ArchiveAccounts
import com.fern.domain.db.RoomTypeConverters
import com.fern.domain.db.migration.Migration105to106_TrnRecurringRules
import com.fern.domain.db.migration.Migration106to107_Wishlist
import com.fern.domain.db.migration.Migration107to108_Sync
import com.fern.domain.db.migration.Migration108to109_Users
import com.fern.domain.db.migration.Migration109to110_PlannedPayments
import com.fern.domain.db.migration.Migration110to111_PlannedPaymentRule
import com.fern.domain.db.migration.Migration111to112_User_testUser
import com.fern.domain.db.migration.Migration112to113_ExchangeRates
import com.fern.domain.db.migration.Migration113to114_Multi_Currency
import com.fern.domain.db.migration.Migration114to115_Category_Account_Icons
import com.fern.domain.db.migration.Migration115to116_Account_Include_In_Balance
import com.fern.domain.db.migration.Migration116to117_SalteEdgeIntgration
import com.fern.domain.db.migration.Migration117to118_Budgets
import com.fern.domain.db.migration.Migration118to119_Loans
import com.fern.domain.db.migration.Migration119to120_LoanTransactions
import com.fern.domain.db.migration.Migration120to121_DropWishlistItem
import com.fern.domain.db.migration.Migration122to123_ExchangeRates
import com.fern.domain.db.migration.Migration125to126_Tags
...
abstract class IvyRoomDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun migrations() = arrayOf(
            ...
            Migration130to131_ArchiveCategories(),
            Migration131to132_ArchiveAccounts()
        )
