...
interface AccountDao {
    @Query("SELECT * FROM accounts WHERE isDeleted = :deleted AND isArchived = :archived ORDER BY orderNum ASC")
    suspend fun findAll(deleted: Boolean = false, archived: Boolean = false): List<AccountEntity>
