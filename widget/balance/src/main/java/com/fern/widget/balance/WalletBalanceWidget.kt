package com.fern.widget.balance
...
import com.fern.legacy.utils.shortenAmount
...
import com.fern.widgets.WidgetBase
...
class WalletBalanceWidgetReceiver : GlanceAppWidgetReceiver() {
    ...
    @Inject
    lateinit var ivyContext: com.fern.legacy.IvyWalletCtx
    ...
    private fun updateData(context: Context) {
        coroutineScope.launch {
            ...
            val appLocked = com.fern.legacy.utils.ioThread {
